...
### 2. 💰 Sales Analysis
*Analyze sales trends across products, categories, ship modes, and customer segments.*

![Sales Analysis](screenshots/Sales_Analysis.png)

### 3. 📈 Profit Analysis
*Evaluate profitability and identify high- and low-performing areas.*

![Profit Analysis](screenshots/Profit_Analysis.png)

### 4. 👥 Customer Analysis
*Understand customer behavior, value, and purchasing trends.*

![Customer Analysis](screenshots/Customer_Analysis.png)

### 5. 📦 Product Analysis
*Measure product performance and identify growth opportunities.*
...
### 7. 💡 Business Insights
*Summarize key findings and provide actionable business recommendations.*
